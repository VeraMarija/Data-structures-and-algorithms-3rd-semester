...
// ne gradi novu listu nego preuredjuje dobivenu listu                                          DONE
LongNumber reverse(LongNumber num);

// cita broj iz tekstualne datoteke znamenku po znamenku i gradi listu (dugi broj)              DONE
LongNumber read_longnum(char* fname);

// zapisuje broj u tekstualnu datoteku znamenku po znamenku                                     DONE
void write_longnum(LongNumber num, char* fname);

// ispisuje broj na ekran                                                                       DONE
void print_longnum(LongNumber num);

// oslobadja listu znamenaka                                                                    DONE
...
// Gradi se potpuno nova lista (broj) kao rezultat.                                             DONE
